...
public interface CultivoRepository extends JpaRepository<Cultivo, Integer> {
    ...
    List<Cultivo> findByTipoCultivo_IdTiposCultivos(Integer idTipoCultivo);

    List<Cultivo> findByTipoCultivo_NombreContainingIgnoreCase(String nombreTipoCultivo);
